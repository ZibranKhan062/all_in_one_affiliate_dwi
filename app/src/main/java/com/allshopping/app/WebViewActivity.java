...
public class WebViewActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbarTextView.setText(web_name.getStringExtra("website_name"));
        webView = (WebView) findViewById(R.id.webview);
        progressbar = findViewById(R.id.progressbar);
        intent = getIntent();
        rec_weblink = intent.getStringExtra("Web");
        Log.e("Data Received is", rec_weblink);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.showAll) {
            ...
            Intent intents = new Intent(WebViewActivity.this, BookMarksActivity.class);
